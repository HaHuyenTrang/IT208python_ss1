...
# biến trong python
a = 10
print(f"địa chỉ của biến a trước khi gắn lại: {id(a)}")
a = 20
print(f"địa chỉ của biến a sau khi gắn lại: {id(a)}")
b = a
print(f"địa chỉ của biến a trong bộ nhớ: {id(a)}")
print(f"địa chỉ của biến a trong bộ nhớ: {id(b)}")
print(id(a) == id(b))
